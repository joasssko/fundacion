...
jQuery(window).scroll(function(){
    if(jQuery(document).scrollTop() > 350)
    {
        if(jQuery('#header').data('size') == 'big')
        {
			...
			jQuery('.home #header').css('border-bottom' , '1px solid #c2c2c2');
			//jQuery('#header').css('box-shadow' , '0 0 10px #000');
			//jQuery('#header').css('background-color' , 'rgba(255,255,255,0.97)');
						
			jQuery('#menu-navegacion li:not(.sub-menu li)').stop().animate({
                marginTop:'20px'
            },600);
			/*jQuery('#logo').stop().animate({
               paddingTop:'0px'
            },600);*/
			//jQuery('#menu-navegacion .current-menu-item a').css('background-position', '-30px');
			//jQuery('#minimenu a').css('color', '#fff');
			//jQuery('.logo img').css('width', '120px');
			//jQuery('#menu-navegacion .current-menu-item a').css('padding-bottom', '8px');
			//jQuery('#menu-navegacion .current-menu-item a').css('border-bottom', '4px solid #4f8aa8');
        }
    }
    else
    {
        if(jQuery('#header').data('size') == 'small')
        {
			...
			jQuery('.home #header').css('border-bottom' , '0px');
			jQuery('#logo').stop().animate({
				width:'234px',
				height:'auto',
				marginTop:'0px',
			...
			//jQuery('#header').css('box-shadow' , '0 0 0 #000');
			//jQuery('#header').css('background-color' , 'rgba(255,255,255,0.9)');
			//jQuery('#menu-navegacion .current-menu-item a').css('background-position', 'bottom center');
			//jQuery('#menu-navegacion .current-menu-item a').css('padding-bottom', '17px');
			//jQuery('#minimenu a').css('color', '#525252');
			//jQuery('.logo img').css('width', '200px');
			//jQuery('#menu-navegacion .current-menu-item a').css('border-bottom', 'none');
			jQuery('#menu-navegacion li:not(.sub-menu li)').stop().animate({
                marginTop:'40px'
            },600);
			/*jQuery('#logo').stop().animate({
